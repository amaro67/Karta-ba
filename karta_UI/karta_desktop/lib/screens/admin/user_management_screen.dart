...
class _UserManagementScreenState extends State<UserManagementScreen> {
  ...
  void _showDeleteUserConfirmation(BuildContext context, AdminProvider adminProvider, Map<String, dynamic> user) {
    ...
    // Sačuvaj originalni context i navigator prije otvaranja dialog-a
          ...
          if (!isCurrentUser)
            ElevatedButton(
              onPressed: () async {
                ...
                Navigator.of(dialogContext).pop(); // Zatvori confirmation dialog
                print('🔵 DELETE: Closed confirmation dialog');
                
                // Koristi originalni context za otvaranje loading dialog-a
                showDialog(
                  context: context, // Originalni context, ne dialogContext!
                ...
                // Koristi sačuvani navigator za zatvaranje loading dialog-a
                if (context.mounted) {
                  navigator.pop(); // Zatvori loading dialog koristeći sačuvani navigator
