...
public interface IVenueService
{
    ...
    Task<VenueDto> UpdateVenueAsync(Guid id, UpdateVenueRequest request, string userId, CancellationToken ct = default);
    Task<bool> DeleteVenueAsync(Guid id, string userId, CancellationToken ct = default);
